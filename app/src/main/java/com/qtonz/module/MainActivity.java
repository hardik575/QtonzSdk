...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnShow.setOnClickListener(v ->
                QtonzAd.getInstance().forceShowInterstitial(MainActivity.this, mInterstitialAd, new AdCallback() {
        }, true));
        ...
        QtonzAd.getInstance().loadNativeAd(this, BuildConfig.ad_native, R.layout.native_medium, frAds, shimmerAds, new AdCallback() {
            @Override
        ...
        // Native Ads: Load
        QtonzAd.getInstance().loadNativeAdResultCallback(this, BuildConfig.ad_native, R.layout.native_medium, new AdCallback() {
            @Override
