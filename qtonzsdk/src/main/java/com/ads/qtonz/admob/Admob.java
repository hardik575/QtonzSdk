...
public class Admob {
    ...
    public void showInterstitialAd(Context context, InterstitialAd mInterstitialAd, AdCallback callback) {
        currentClicked++;
                        ...
                        mInterstitialAd.setOnPaidEventListener(adValue -> {
                            QtonzLogEventManager.logPaidAdImpression(context,
                                    ...
                                    mInterstitialAd.getResponseInfo()
                                            .getMediationAdapterClassName(), AdType.INTERSTITIAL);
                            if (tokenAdjust != null) {
                                QtonzLogEventManager.logPaidAdjustWithToken(adValue, mInterstitialAd.getAdUnitId(), tokenAdjust);
                            }
                        });
